...
import com.fedtech.pension.nurse.service.NurseRequestService;
...
@Controller
@RequestMapping("/admin/api/power/elderlyhealth/")
@EnableScheduling
public class ElderlyHealthController extends BaseController {
    ...
    @ResponseBody
    public PageResponse<NurseRequest> getHappyList(NurseRequest filter, PageRequest pageRequest) throws Exception{
        return nurseRequestService.selectPageList(filter,pageRequest);
    }
