            ...
            $('#elderInfo_add').bootstrapWizard({
                ...
                onNext: function (tab, navigation, index) {
                    ...
                    if (index == 1) {
                        ...
                        if (areaName == null || areaName == "") {
                        ...
                        else if ($("#addElderForm input[name=name]").val() == null || $("#addElderForm input[name=name]").val() == "") {
                            _self.error.html('<button class="close" data-dismiss="alert"></button>请输入就业人员姓名');
                            _self.error.show();
                            Metronic.scrollTo(_self.error, -200);
                            return false;
                        } else if ($("#addElderForm input[name=cardNo]").val() == null || $("#addElderForm input[name=cardNo]").val() == "") {
                            ...
                            $.ajax({
                                type: "post",
                                url: window.apppath + "/admin/api/elderly/addJiuYe",
