 ...
 */
var ElderMsgSmsList = function () {
    var _self = "";
    var tableContainer = $("#datatable_sms_list").parents(".table-container");
    return {
        grid: "",
        init: function () {
            _self = this;
            ...
            _self.grid.init({
                ...
                dataTable: {
                    "ajax": function (params, callback, obj) {
                        $.post(window.apppath + "/admin/api/sms/elderMsgList", {
                        ...
                        },
                        {
                            "data": "id", render: function (data, type, row, meta) {
                               ...
                               // columnHtml += '<button data-id="' + data + '"  class="btn default btn-xs green-stripe update">修改</button>';
                                //columnHtml += '<button data-id="' + data + '"  class="btn default btn-xs blue-stripe info" data-toggle="modal" data-target="#impModal">详细</button>';
            ...
            _self.grid.getTable().on("click", "button.del", function (e) {
                ...
                $(this).confirmation({
                    ...
                    'onConfirm': function () {
                        ...
                        $.post(window.apppath + "/admin/api/sms/delete", {id: Id}, function (res) {
