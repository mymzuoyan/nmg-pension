var EntrySubsidyList = function () {
    ...
    var handleList = function (method) {
        ...
        grid.init({
            ...
            dataTable: {
                "ajax": function (params, callback, obj) {
                    $.post(window.apppath + "/admin/api/entrySubsidy/list",
                        {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        var html = "";
                        if($("#verity").val() == 0){
                            html += '<a data="' + window.apppath + '/admin/entrySubsidy/verity/' + data + '" class="btn default btn-xs green-stripe info" >审核</a>';
                        }
                        return html;
                    }
                    }
        ...
        grid.getTable().on("click", "a.info", function () {
            ...
            window.parent.addTab("tab_entry_subsidy", "入职补贴审核", href);
        });
        //批量删除
        ...
        function updateArticles(deleteIds) {
            ...
            $.post(window.apppath + "/admin/api/entrySubsidy/deleteSomeMsg", {
                deleteIds: deleteIds
            }, function (res) {
