 ...
 */
var GoldSendBankReissueList = function () {
    ...
    return {
        init: function () {
            ...
            $(".excel").click(function () {
                window.location.href = window.apppath + "/admin/api/gold/goldSend/exportExcel4?" +
                    "areaName=" + $("#areaName").val() +
                    "&idcardno=" + $("#idcardno").val() +
                    "&elderName=" + $("#elderName").val() +
                    "&fafangWay=" + $("#fafangWay").val()
            })
        },
            ...
            _self.grid.init({
                ...
                dataTable: {
                    "ajax": function (params, callback, obj) {
                        $.post(window.apppath + "/admin/api/gold/goldSend/sendBankBufaList", {
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            if(data!= null){
                                data =data.replace(/(\d{4}).(\d{1,2}).(\d{1,2}).+/mg, '$1-$2-$3');
                                return data;
                            }else {
                                return "";
                            }
                        ...
                        {
                            "data": "monthCount1" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "goldSendStandard.moneyStandard1" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "monthCount2" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "goldSendStandard.moneyStandard2" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "monthCount3" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "goldSendStandard.moneyStandard3" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "monthCount4" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "goldSendStandard.moneyStandard4" , render: function (data, type, row, meta) {
                            if(data != null){
                                return data;
                            }else {
                                return 0;
                        ...
                        {
                            "data": "goldElderly.bankCardOwner"
                        },
                        {
