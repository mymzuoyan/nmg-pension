...
var JiuYeXiuGaiList = function () {
    ...
    return {
            ...
            _self.grid.init({
                ...
                dataTable: {
                    "ajax": function (params, callback, obj) {
                        $.post(window.apppath + "/admin/api/gold/goldSend/list", {
                            length: params.length,
                            start: params.start,
                            areaName: $("#areaName").val(),
                            fafangTimeString: $("input[name=fafangTimeString]").val(),
                            idcardno: $("#idcardno").val(),
                            elderName: $("#elderName").val(),
                            applyType: $("#applyType").val(),
                            orderField: 'id',
                    ...
                    "columns": [
                        ...
                        {
                            "data": "fafangTime" /*, render: function (data, type, row, meta) {
                            if(data!= null && data !=""){
        ...
        getAreaValue: function (serviceOrgName, serviceId) {
            document.getElementById("serviceOrgName").value = serviceOrgName;
