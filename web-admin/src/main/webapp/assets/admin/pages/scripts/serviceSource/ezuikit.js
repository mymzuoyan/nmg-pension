...
( function( global, factory ) {
  ...
  var ckplayerJS = Domain + '/assets/admin/pages/scripts/serviceSource/ckplayer.js';
  var ckplayerSWF = Domain + '/assets/admin/pages/scripts/serviceSource/ckplayer.swf';
  var m3u8SWF = Domain + '/assets/admin/pages/scripts/serviceSource/m3u8.swf';
  var hlsJS = Domain + '/assets/admin/pages/scripts/serviceSource/hls.js';
