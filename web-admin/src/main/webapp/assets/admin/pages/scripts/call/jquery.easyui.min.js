...
if(_50.text){
	if(_50.iconCls && _50.iconCls.indexOf("icon2-")!=-1){
		$(_4f).addClass("l-btn2");
		$(_4f).html(_50.text).wrapInner("<span class=\"l-btn-left\">"+"<span class=\"l-btn-text2\">"+"</span>"+"</span>");
	}else{
		$(_4f).html(_50.text).wrapInner("<span class=\"l-btn-left\">"+"<span class=\"l-btn-text\">"+"</span>"+"</span>");
	}
if(_50.iconCls){
	if(_50.iconCls.indexOf("icon2-")!=-1){
		$(_4f).find(".l-btn-text2").addClass(_50.iconCls).css("padding-left","40px");
	}else{
