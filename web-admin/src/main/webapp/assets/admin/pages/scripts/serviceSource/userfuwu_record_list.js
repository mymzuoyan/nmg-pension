            ...
            _self.grid.init({
                ...
                dataTable: {
                    "ajax": function (params, callback, obj) {
                        $.post(window.apppath + "/admin/api/user/fuwu/record/listData", {
                    ...
                    "columns": [
                        ...
                        {
                            "data": "scCount", render: function (data, type, row, meta) {
                                return data != null ? data : 0;
                            }
                        },
                        {
                            "data": "jhCount", render: function (data, type, row, meta) {
                                return data != null ? data : 0;
                            }
                        },
                        {
                            "data": null, render: function (data, type, row, meta) {
                                return Number(data.scCount) + Number(data.jhCount);
                            }
                        },
                        {
