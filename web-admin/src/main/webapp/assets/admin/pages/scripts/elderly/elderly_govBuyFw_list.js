                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            if($("#elderGoveInfoList").val()=="1"){
                                html += '<div style="text-overflow: ellipsis;width: 140px;overflow: hidden;">' + '<a href="' + window.apppath + '/admin/elderly/govbuyfw/detail/' + data + '" class="btn default btn-xs blue-stripe">查看</a>';
                            }
                            if (row.status == 1 && $("#elderGoveInfoUpdate").val()=="1"){
                                html += '<button data="' + data + '" class="btn btn-xs red-stripe del">删除</button>';
                            }
