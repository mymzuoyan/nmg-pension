var CommunityDonationList = function () {
    var grid = "";
    var type = 2;
    var handleList = function (method) {
        ...
        grid.init({
            ...
            dataTable: {
                "ajax": function (params, callback, obj) {
                    $.post(window.apppath + "/admin/api/power/socialDonation/getSocialDonationList",
                        {
                ...
                "columns": [
                   ...
                   /* {
                    ...
                    {
                        "data": "activityDescription", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                                return data;
                            } else {
                                return "";
                    ...
                    {
                        "data": "activityLeader", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                                return data;
                            } else {
                                return "";
                    ...
                    {
                        "data": "beginTime", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                                return data;
                            } else {
                                return "";
                   ...
                   //组织名称
                    ...
                    {
                        "data": "donorName", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                                return data;
                            } else {
                                return "";
                    ...
                    {
                        "data": "provinceBurg", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                                return data;
                            } else {
                                return "";
                    ...
                    //捐赠人照片
                    {
                        "data": "donorPic", render: function (data, type, row, meta) {
                            if (data != "" && data != null) {
                               /* if(row.photoFlag == 2){*/
                    ...
                    {
                        "data": "donorType", render: function (data, type, row, meta) {
                            if (data == 1) {
                                return "资金";
                            }
                            if (data == 2) {
        ...
        function updateArticles(deleteIds) {
            ...
            $.post(window.apppath + "/admin/api/power/socialDonation/deleteSome", {
                deleteIds: deleteIds
            }, function (res) {
                Metronic.unblockUI(tableContainer);
