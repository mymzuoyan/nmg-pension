    ...
    InfoBox.prototype.getOffset = function () {
        ...
        baidu.object.extend(InfoBox.prototype, {
            ...
            _getCloseIcon: function () {
                if (this._opts.closeIconUrl != "null") {
            ...
            _adjustPosition: function (poi) {
                ...
                if (this._marker) {
                    this._div.style.left = pixel.x - icon.anchor.width + this._marker.getOffset().width + icon.infoWindowAnchor.width - this._boxWidth / 2 + 135 + "px";
                } else {
