...
!function (a) {
    ...
    "use strict";
    var b = a(window), c = a(document), d = function (b, c) {
    ...
    d.prototype = {
        constructor: d, init: function () {
            ...
            this.active && (this.active = !1, this.$element.off({
                ...
                keyup: this.keyup
            }), this.$completer.off({mousedown: this.mousedown, mouseover: this.mouseover}))
        }, attach: function (b) {
            ...
            var a = this.defaults, b = a.filter(this.$element.val()).toString();
            ...
            this.hide(), this.disable(), this.$element.off({focus: this.enable, blur: this.disable})
        }
    }, d.defaults = {
        itemTag: "li",
        position: "bottom",
