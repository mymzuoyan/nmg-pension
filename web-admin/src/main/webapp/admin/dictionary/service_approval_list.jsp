...
<tiles:insertDefinition name="tiles.template.admin.layout">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="serviceType" type="text"
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/dictionary/service_approval_list.js?v=1.5"></script>
