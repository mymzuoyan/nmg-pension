...
<tiles:insertDefinition name="tiles.template.admin.layout">
    ...
    <tiles:putAttribute name="page_content">
        ...
        <shior:hasPermission name="elderServiceWebsite-newsManager-type-update">
            <input type="hidden" id="elderServiceTypeUpdate" value="1"/>
        </shior:hasPermission>
        <shior:hasPermission name="elderServiceWebsite-newsManager-type-delete">
            <input type="hidden" id="elderServiceTypeDel" value="1"/>
        </shior:hasPermission>
        <div class="row">
            <div class="col-md-12">
                <div class="portlet ">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-4 col-md-8">
                                                    <shiro:hasPermission name="elderServiceWebsite-newsManager-type-create">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/portal/module_list.js?v=1.0"></script>
