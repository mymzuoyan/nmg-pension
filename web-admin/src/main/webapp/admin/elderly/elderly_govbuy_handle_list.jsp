...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">政购待审列表</span>
                        </div>
                        <div class="tools">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/capacity/elderGovBuyHandle.js?v=2.34"></script>
