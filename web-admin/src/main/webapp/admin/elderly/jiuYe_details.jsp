...
<tiles:insertDefinition name="tiles.template.admin.layout">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${method=='edit'}">
                                    <span class="caption-subject font-red-sunglo bold uppercase">从业人员补贴信息查看</span>
                                </c:when>
                            </c:choose>
                        </div>
                        <div class="tools">
                                    ...
                                    <div style="float: right;margin-right: 15px;margin-top: 5px;margin-bottom: 5px;">
                                        <div style="width:80px;float:left;display: block;padding-right: 10px;">
                                            <a class="btn btn-circle green"
                                               onclick="JiuYeCommon.allowEdit()"><i
                                                    class="fa">修改</i></a>
                                        </div>
                                    </div>
                                </c:when>
                                        ...
                                        <table border="1"
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%" style="vertical-align:middle;">
                                                    <input class="form-control" name="areaNameDiv" id="areaNameDiv" value="${jiuYe.areaName}"
                                                ...
                                                <td style="text-align:center;vertical-align:middle;">
                                                    <input name="serviceOrgName" type="text"
                                                           value="${jiuYe.serviceOrgName}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align:center;vertical-align:middle;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    <input maxlength="18" name="cardNo" type="text" id="cardNo"
                                                           value="${jiuYe.cardNo}"
                                            ...
                                            <%--</tr>--%>
                                            <tr>
                                                <td style="text-align:center;vertical-align:middle;">补贴金额
                                                </td>
                                                <td style="text-align:center;vertical-align:middle;">
                                                    <input name="buTieMoney" type="text"
                                                           value="${jiuYe.buTieMoney}"/>
                                                </td>
                                                <td style="vertical-align:middle;text-align:center;">备注</td>
                                                <td style="vertical-align:middle;">
                                                    <input maxlength="30" name="remarks" type="text"
                                                           value="${jiuYe.remarks}">
                                                </td>
                                            </tr>
                                        ...
                                        <c:choose>
                                            <c:when test="${method=='edit'}">
                                                <div style="text-align: right;width: 40%; margin-right: 71px; display: inline-block;">
                                                    ...
                                                    <button type="button" onclick="JiuYeCommon.editElder()"
                                                            name="editElder"
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/common.js"
                type="text/javascript"></script>
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/elderly/jiuYe_common.js?v=1.3"
                type="text/javascript"></script>
