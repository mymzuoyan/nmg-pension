...
<tiles:insertDefinition name="tiles.template.admin.layout">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <div style="float: left">
                                <a href="javascript:void(0)" onclick="ElderMsgPoorVerification.verification()"
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" class="table1">
                                    ...
                                    <tr>
                                        ...
                                        <td width="208" align="center">
                                            <input type="text" name="name" value="${apply.name}" size="20" class="form-control" readonly
                                                   style="width: 100%;"/>
                                        </td>
                                        ...
                                        <td width="246" rowspan="">
                                            <input type="text" name="idcardno" class="form-control" value="${apply.idcardno}" readonly
                                            />
                                        </td>
                                        ...
                                        <td align="left">
                                            <input id="sex1" type="radio" name="sex" value="1" readonly="readonly"disabled
                                                    <c:if test="${apply.sex==1}"> checked</c:if> />
                                            <label for="sex1">男</label>
                                            <input id="sex2" type="radio" name="sex" value="2" readonly="readonly" disabled
                                                    <c:if test="${apply.sex==2}"> checked</c:if>/>
                                            <label for="sex2">女</label>
                                        </td>
                                        <td rowspan="3" style="width: 200px;height: 200px;" >
                                            <img style="width: 100%;height: 100%" src="${pageContext.request.contextPath }${apply.avatar}">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <lb:select name="nation" cssClass="form-control" value="${apply.nation}" readOnly="true">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/elderly/elderly_poor_verification.js?v=3.4"
                type="text/javascript"></script>
        <script>
            jQuery(document).ready(function () {
                ...
                ElderMsgPoorVerification.init("${id}","${apply.id}");
            });
