...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">市场工单记录</span>
                        </div>
                        <div class="tools">
                            <a href="" class="expand">
                            </a>
                            ...
                            <tr>
                                ...
                                <td width="20%" style="text-align:center;vertical-align:middle;">
                                    <input name="receiverName" class="form-control"
                                           type="text"/>
                                    <input type="hidden" name="idcardno" value="${elderlyWallet.idcardno}">
                                </td>
                            </tr>
                            <tr>
                                <td width="14%" style="text-align:center;vertical-align:middle;">
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="ElderlyWalletInfoList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/elderly/elderly_wallet_infoList.js?v=1.24"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <script>
            jQuery(document).ready(function () {
                Metronic.init();
                Layout.init();
                ElderlyWalletInfoList.init();
