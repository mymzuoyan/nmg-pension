...
<tiles:insertDefinition name="tiles.template.admin.layout">
                                ...
                                <tr>
                                    ...
                                    <td width="20%" style="text-align:center;vertical-align:middle;"
                                        ...
                                        <select id="queueName" class="form-control">
                                            ...
                                            <option value="200">12349热线</option>
                    ...
                    <div style="text-align: right">
                        ...
                        <div class="pagination-panel"> 页数 <input type="text" id="page"
                            ...
                            <button
                                    ...
                                    onclick="CallInfoAbnormalList.goToPage()"
                                    title="GO">GO
                            </button>
                        </div>
                    </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/call/callInfo_abnormal_list.js?v=2.41"></script>
        <script type="text/javascript"
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                EographicArea.init();
                CallInfoAbnormalList.setAreaName("${sessionScope.login_user.areaName}");
                CallInfoAbnormalList.init();
            });
        </script>
    </tiles:putAttribute>
