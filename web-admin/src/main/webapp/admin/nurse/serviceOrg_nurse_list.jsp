...
<tiles:insertDefinition name="tiles.template.admin.layout">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    ...
                    <shior:hasPermission name="nurse-manager-system-jpInfo">
                        <input type="hidden" id="nurseManagerSysInfo" value="1"/>
                    </shior:hasPermission>
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input class="form-control" id="institutionName" name="institutionName" placeholder="请输入单位名称"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        组织类型
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover"
                                       id="datatable_serviceOrg_nurse_List">
                                    <thead>
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="ServiceOrgNurseList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn blue"
                                onclick="ServiceOrgNurseList.getAreaName()">
                            确定
                        </button>
                        <button type="button"
                                class="btn default"
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/global/plugins/jstree/dist/jstree.min.js"
                type="text/javascript"></script>
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/nurse/serviceOrg_nurse_list.js?v=2.4"
                type="text/javascript"></script>
        <script>
