...
<tiles:insertDefinition name="tiles.template.admin.layout">
                            ...
                            <tr>
                                ...
                                <td width="20%" style="text-align:center;vertical-align:middle;">
                                    <select name="role" class="form-control" id="role">
                                        ...
                                        <option value="组织管理员">组织管理员</option>
                            ...
                            <div class="table-actions-check-wrapper" style="text-align: right;margin-right: 10px">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="TaskList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/task/task_list.js?v=1.1"></script>
