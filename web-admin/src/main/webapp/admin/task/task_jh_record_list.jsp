...
<tiles:insertDefinition name="tiles.template.admin.layout">
                                ...
                                <li class="">
                                    <a onclick="if(!$(this).parent().hasClass('active'))
                                       ...
                                       data-toggle="tab" aria-expanded="false"><span
                                            ...
                                            style="border-bottom: hidden">市场工单记录</span>
                                    </a>
                                </li>
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="Task_Jh_Record_List.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/task/task_jh_record_list.js?v=3.31"></script>
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                Task_Jh_Record_List.init(receiverId);
