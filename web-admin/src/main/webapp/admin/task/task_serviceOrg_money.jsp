...
<tiles:insertDefinition name="tiles.template.admin.layout">
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover"
                                   id="datatable_task_serviceOrg_money">
                                <thead>
                            ...
                            <div class="table-actions-check-wrapper" style="text-align: right;margin-right: 10px">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="TaskServiceOrgMoneyList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/task/task_serviceOrg_money.js?v=1.4"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <script>
            jQuery(document).ready(function () {
                Metronic.init();
                Layout.init();
                TaskServiceOrgMoneyList.init();
            });
        </script>
    </tiles:putAttribute>
