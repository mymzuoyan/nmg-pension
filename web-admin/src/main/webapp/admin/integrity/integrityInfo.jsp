                ...
                <div class="portlet ">
                    ...
                    <div class="portlet-body form">
                        <div class="form-horizontal">
                            <!-- PERSONAL INFO TAB -->
                            <div class="form-body">
                                <input type="hidden" id="integrityId" value="${integrity.id}">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" id="module">
                                            <c:if test="${integrity.flag==1}">
                                                <option Value="1">曝光台</option>
                                            </c:if>
                                            <c:if test="${integrity.flag==0}">
                                    ...
                                    <div class="col-md-4">
                                        <input name="score" type="text" class="form-control"
                                               value="${integrity.score}" readonly="readonly">
                                    </div>
                                    <label class="col-md-2 control-label">部门名字
                                        <span class="required">	* </span>
                                    </label>
                                    <div class="col-md-4">
                                        <input name="institutionName" type="text" class="form-control"
                                               value="${integrity.institutionName}" readonly="readonly">
                                    </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                ue.ready(function () {
                    //设置编辑器的内容
                    ue.setContent('${integrity.context}');
                });
                ...
                $("#btnPublish").click(function (e) {
                    ...
                    }else if($("input[name='score']").val()==""||$("input[name='score']").val()==null )
                    {
                        ...
                        $("#labelmsg").text('');
                        $.post(window.apppath + "/admin/api/Integrity/update", {
                            id:$("#integrityId").val(),
                            title: a_title,
                            context: a_content,
