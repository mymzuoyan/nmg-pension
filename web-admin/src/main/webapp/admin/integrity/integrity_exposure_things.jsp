...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">曝光台</span>
                    ...
                    <div class="portlet-body" style="padding-top: 0px !important;display: none">
                        ...
                        <%--</c:if>--%>
                    <shior:hasPermission name="expourse-showList-delete">
                    <input type="hidden" id="exposureDelete" value="1"/>
                    </shior:hasPermission>
                    <div class="portlet">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/integrity/integrity_exposure_things.js?v=1.0"></script>
