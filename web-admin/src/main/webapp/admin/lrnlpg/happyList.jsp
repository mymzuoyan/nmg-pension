...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">文娱活动信息管理列表</span>
                        </div>
                        <div class="tools">
                            <shior:hasPermission name="recreational-activities-add">
                                <div style="float: left">
                                    <a data="${pageContext.request.contextPath}/admin/api/power/bill/happyAdd"
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input name="activityTime" placeholder="请输入活动名称" value=""
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" >
                                        <input class="form-control" name="participantsNumber" placeholder="请输入参与人数"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        活动内容
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;" colspan="3">
                                        <input class="form-control" name="activityContent" placeholder="请输入活动内容"
                                               style="width: 100%">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" >
                                        <input class="form-control" name="organizer" placeholder="请输入组织者"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        活动地址
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;" colspan="3">
                                        <input class="form-control" name="address" placeholder="请输入活动地址"
                                               style="width: 100%">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="HappyList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/lrnlpg/happy_list.js?v=2.7"
                type="text/javascript"></script>
        <script type="text/javascript"
