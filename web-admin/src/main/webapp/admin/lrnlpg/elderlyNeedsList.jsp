...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">旅居老人需求管理列表</span>
                        </div>
                        <div class="tools">
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" >
                                        <input class="form-control" name="demandContent" placeholder="请输入需求内容"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        需求时间
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;" colspan="3">
                                        <input class="form-control date-picker" name="needsTime" data-date-format="yyyy-mm-dd" placeholder="请输入需求时间"
                                               style="width: 100%">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="ElderlyNeedsList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/lrnlpg/elderlyNeeds_list.js?v=2.6"
                type="text/javascript"></script>
        <script type="text/javascript"
