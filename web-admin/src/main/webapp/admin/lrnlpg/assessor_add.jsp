                                ...
                                <div id="tab2" class="tab-pane">
                                    <table class="table table-bordered table-hover table-condensed table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:20%;text-align:center;vertical-align:middle;">
                                                <input type="radio" value="保密" name="sex" <c:if test="${assessor.sex eq '停用'}">checked</c:if> class="colored-blue">
                                                <span class="text">保密</span>
                                                <input name="sex" value="男" type="radio" <c:if test="${assessor.sex eq '停用'}">checked</c:if> class="colored-blue">
                                                <span class="text">男</span>
                                                <input name="sex" value="女" type="radio" <c:if test="${assessor.sex eq '停用'}">checked</c:if> class="colored-blue">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:20%;text-align:center;vertical-align:middle;">
                                                <input type="radio" value="正常服务" name="serverStatus" <c:if test="${assessor.serverStatus eq '停用'}">checked</c:if> class="colored-blue">
                                                <span class="text">正常服务</span>
                                                <input name="serverStatus" value="停止服务" <c:if test="${assessor.serverStatus eq '停用'}">checked</c:if> type="radio" class="colored-blue">
