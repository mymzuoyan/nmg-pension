...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">社会服务信息管理列表</span>
                        </div>
                        <div class="tools">
                            <shior:hasPermission name="community-service-add">
                                <div style="float: left">
                                    <a data="${pageContext.request.contextPath}/admin/api/power/socialWork/communityServiceListAdd"
                            ...
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input class="form-control" name="serviceItem" placeholder="请输入服务项目"
                                               style="width: 100%">
                                    </td>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input class="form-control" name="principal" placeholder="请输入负责人"
                                               style="width: 100%">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" >
                                        <input class="form-control date-picker" name="serviceStartTime" placeholder="请输入服务开始时间"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        服务日记
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;" colspan="3">
                                        <input class="form-control" name="serviceDiary" placeholder="请输入服务日记"
                                               style="width: 100%">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="CommunityServiceList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/lrnlpg/communityService_list.js?v=2.6"
                type="text/javascript"></script>
        <script type="text/javascript"
