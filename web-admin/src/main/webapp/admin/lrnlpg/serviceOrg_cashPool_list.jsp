...
<tiles:insertDefinition name="tiles.template.admin.layout">
                                ...
                                <li class="active">
                                    <a onclick="if(!$(this).parent().hasClass('active')) window.location.href='${pageContext.request.contextPath}/admin/serviceOrgShow'"
                                       data-toggle="tab" aria-expanded="false"><span
                                            ...
                                            style="border-bottom: hidden">组织机构资金流水列表</span></a>
                                </li>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/service_org_cashPool.js?v=1.6"
                type="text/javascript"></script>
