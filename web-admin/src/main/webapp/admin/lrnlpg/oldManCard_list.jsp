                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">老人绑卡列表</span>
                        </div>
                        <div class="tools">
                            <shior:hasPermission name="lrpggl-oldmancard-list-create">
                                <div style="float: left">
                                    <a data="${pageContext.request.contextPath}/admin/api/power/oldmancard/add"
                                       class=" table-group-action-add btn btn-circle btn-add"><i class="fa">绑卡</i></a>
                                </div>
                            </shior:hasPermission>
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        ...
                                        <%--<input type="hidden" id="areaId" name="areaId">--%>
                                            <input class="form-control" name="serviceOrgName" placeholder="请输入所属服务机构"
                                                   style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                       老人姓名
                                    ...
                                    <td style="width:25%;text-align:center;vertical-align:middle;" >
                                        <input class="form-control" name="oldManName" placeholder="请输入老人姓名"
                                               style="width: 100%">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        卡号
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" >
                                        <input class="form-control" name="idNumber" placeholder="身份证号"
                                               style="width: 100%">
                                    </td>
                                    <td style="text-align:center;vertical-align:middle;">
                                        绑卡时间
                                    ...
                                    <td>
                                        <input style="width:40%;display: inline-block" type="text"
                                               class="form-control date-picker" name="startRemoveDate" id="startRemoveDate"
                                               data-date-format="yyyy-mm-dd">
                                        至
                                        <input style="width:40%;display: inline-block" type="text"
                                               class="form-control date-picker" name="endRemoveDate" id="endRemoveDate"
                                               data-date-format="yyyy-mm-dd">
                                    </td>
                                </tr>
                            </table>
