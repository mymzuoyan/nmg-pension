...
<tiles:insertDefinition name="tiles.template.admin.layout">
    ...
    <tiles:putAttribute name="page_content">
        <div class="row" style="height: 100% !important;">
            <div class="col-md-12" style="height: 100% !important;">
                ...
                <input id="braceletId" type="hidden" value="${braceletId}">
                <div id="myMap" style="height: 100% !important;"></div>
            </div>
        </div>
    </tiles:putAttribute>
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/bracelet/bracelet_view_location.js?v=3.2"></script>
        <script>
            jQuery(document).ready(function () {
                Metronic.init();
                Layout.init();
                BraceletViewLocation.init();
                BraceletViewLocation.addMarker();
            });
        </script>
    </tiles:putAttribute>
