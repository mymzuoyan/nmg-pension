...
<tiles:insertDefinition name="tiles.template.admin.layout">
                                ...
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        ...
                                        <c:if test="${empty areaName}">
                                               ...
                                               onclick="BraceletObjectInfo.selectMethod('add');" style="width: 100%">
                                    ...
                                    <td style="width:15%;text-align:center;vertical-align:middle;">
                                        <input type="text" id="elderName" name="elderName" class="form-control">
                                    </td>
                                    <td style="width:10%;text-align:center;vertical-align:middle;">
                                        年龄
                                    </td>
                                    <td style="width:40%;text-align:center;vertical-align:middle;">
                                        <input style="width:40%;display: inline-block" type="text"
                                               class="form-control" name="startAge">
                                        至
                                        <input style="width:40%;display: inline-block" type="text"
                                               class="form-control" name="endAge">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input style="display: inline-block" type="text"
                                               class="form-control" id ="deviceNumber" name="deviceNumber">
                                    </td>
                                    <td style="text-align:center;vertical-align:middle;">
                                        用户号码
                                    </td>
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <input style="display: inline-block" type="text"
                                               class="form-control" id = "deviceMobile" name="deviceMobile">
                                    </td>
                                    <td style="text-align:center;vertical-align:middle;">
                                        性别
                                    </td>
                                    <td style="width:20%;text-align:center;vertical-align:middle;">
                                        <select id="sexDictId" name = "sexDictId" class="form-control">
                                            <option value="">
                                                -- 请选择 --
                                            </option>
                                            <option value="1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn blue"
                                onclick="BraceletObjectInfo.getAreaName()">
                            确定
                        </button>
                        <button type="button"
                                class="btn default"
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <a href="#" class="btn btn-icon-only green"
                                           onclick="importExcel('file','/admin/api/loveBracelet/import')">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/global/plugins/jstree/dist/jstree.min.js"
                type="text/javascript"></script>
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/bracelet/bracelet_object_info.js?v=1.4"
                type="text/javascript"></script>
        <script>
