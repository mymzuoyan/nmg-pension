...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">历史服务记录</span>
                        </div>
                        <div class="tools">
                            <a href="" class="expand">
                            </a>
                            ...
                            <tr>
                                ...
                                <td width="20%" style="text-align:center;vertical-align:middle;">
                                    <input name="receiverServiceOrg" class="form-control"
                                           type="text" value="${serviceOrg.institutionName}" readonly/>
                                </td>
                                <td width="14%" style="text-align:center;vertical-align:middle;">
                                    服务人员：
                                </td>
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="TaskAllList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/task/task_all_list.js?v=3.3"></script>
