...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="height: 90% !important;">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <shiro:hasPermission name="pension-service-manager-communityPensionStarsList-add">
                                <div style="float: left">
                                    <a class="btn btn-circle btn-add" id="addTab1"
                                       data="${pageContext.request.contextPath}/admin/institution/org/communityPensionStars/add"><i
                                            class="fa">申请</i></a>
                                </div>
                                </shiro:hasPermission>
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="CommunityPensionStarsList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                            <div class="right" style="text-align: right;display: block;">
                                <button id="deleteSomeMsg" class="btn btn-circle red"
                                        onclick="deleteSomeMsg(this,'/admin/api/institution/org/communityPensionStars/deleteSome')"
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/community_pension_stars_list.js?v=2.1"></script>
        <script type="text/javascript"
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                CommunityPensionStarsList.init();
