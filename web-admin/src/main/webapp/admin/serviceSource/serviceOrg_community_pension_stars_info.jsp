    ...
    <tiles:putAttribute name="page_content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <shiro:hasPermission name="pension-service-manager-communityPensionStarsList-update">
...
*/
                ...
                $.post(window.apppath + "/admin/api/institution/org/communityPensionStars/updata", {
