...
<tiles:insertDefinition name="tiles.template.admin.layout">
            ...
            <div class="col-md-12">
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <shior:hasPermission name="home-pro-manager-system-person-service-org-create">
                            <div style="float: left">
                                <a data="${pageContext.request.contextPath}/admin/serviceOrg/add"
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            ...
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;">
                                        <input class="form-control" name="applyIdcardNo" placeholder="请输入身份证号"
                                               style="width: 100%">
                                    </td>
                                </tr>
                            </table>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/service_org.js?v=1.9"
                type="text/javascript"></script>
