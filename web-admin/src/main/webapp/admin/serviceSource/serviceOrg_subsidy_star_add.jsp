...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " id="elderInfo_add">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">养老机构服务质量星级评定</span>
                        </div>
                    </div>
                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                        <li>
                                            <a href="#tab1" data-toggle="tab" class="step">
												...
												1 </span>
                                                <span class="desc">
												<i class="fa fa-check"></i> 必备项（星级）</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab2" data-toggle="tab" class="step">
												...
												2 </span>
                                                <span class="desc">
												<i class="fa fa-check"></i> 评分项（安全部分）300分</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab3" data-toggle="tab" class="step">
												...
												3 </span>
                                                <span class="desc">
												<i class="fa fa-check"></i> 评分项（服务部分）350分</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab4" data-toggle="tab" class="step active">
												...
												4 </span>
                                                <span class="desc">
												<i class="fa fa-check"></i> 评分项（管理部分）200分</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab5" data-toggle="tab" class="step">
												...
												5 </span>
                                                <span class="desc">
												<i class="fa fa-check"></i> 评分项（设施部分）150分</span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab1">
                                            <table border="1"
                                                ...
                                                <tr>
                                                    <td style="text-align:center;vertical-align:middle;">星级</td>
                                                    <td style="text-align:center;vertical-align:middle;" colspan="5">
                                                        <select onchange="sure()" name="starClass"
                                                                class="table-group-action-input form-control input-inline " style="width: 600px;">
                                                ...
                                                <tr id="t2" class="t1">
                                                    ...
                                                    <td id="r1" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m1" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input name="area" type="radio" value="1" />&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input name="area" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t3" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r2" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m2" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input name="proportRequirements" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input name="proportRequirements" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t4" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r3" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m3" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="educationalRequirements" name="educationalRequirements" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="educationalRequirements1" name="educationalRequirements" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t5" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r4" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m4" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="professionalRequirements" name="professionalRequirements" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="professionalRequirements1" name="professionalRequirements" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t6" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r5" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m5" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="proportion" name="proportion" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="proportion1" name="proportion" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t7" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r6" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m6" style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="occupancyRate" name="occupancyRate" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="occupancyRate1" name="occupancyRate" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t8" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r7" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m7"  style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="diningAreaRequirements" name="diningAreaRequirements" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="diningAreaRequirements1" name="diningAreaRequirements" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t9" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r8" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m8"  style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="rehabilitationAreaRequirements" name="rehabilitationAreaRequirements" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="rehabilitationAreaRequirements1" name="rehabilitationAreaRequirements" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                                <tr id="t10" class="t1">
                                                    <td style="text-align:center;vertical-align:middle;" colspan="3">
                                                    ...
                                                    <td id="r9" style="text-align:center;vertical-align:middle;" colspan="2">
                                                    </td>
                                                    <td id="m9"  style="text-align:center;vertical-align:middle;" colspan="2">
                                                        <label><input id="serviceItems" name="serviceItems" type="radio" value="1"/>&nbsp;&nbsp;&nbsp;满足</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label><input id="serviceItems1" name="serviceItems" type="radio" value="2" />&nbsp;&nbsp;&nbsp;不满足</label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="tab-pane" id="tab2">
                                            <table border="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5">
                                                        <div class="checkbox-list">
                                                            <label class="checkbox-inline" style="padding-left: 0px">
                                                                <input type="checkbox" name="fraction01" data-score="20"
                                                    ...
                                                    <td style="color:red" class="pf1" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf2" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf3" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf4" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf5" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf6" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf7" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf8" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf9" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf10" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf11" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf12" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf13" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf14" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf15" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf16" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf17" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf18" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color:red" class="pf20" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf21" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf22" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="13"
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            <table border="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color:red" class="pf23" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf24" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf25" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf26" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf27" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf28" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf29" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf30" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf31" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf32" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf33" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf34" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf35" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf36" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf37" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf38" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf39" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf40" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf41" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="13"
                                                        style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            <table border="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color:red" class="pf42" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf43" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf44" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf45" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf46" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf47" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf48" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf49" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf50" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td colspan="5">
                                                        <div class="checkbox-list">
                                                            ...
                                                            <label class="checkbox-inline" style="padding-left: 0px">
                                                                <input type="checkbox" name="fraction51" data-score="1"
                                                    ...
                                                    <td style="color:red" class="pf51" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf52" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf53" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf54" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf55" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf56" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf57" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf58" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf59" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf60" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf61" style="text-align: center"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1"
                                                        style="text-align:center;vertical-align:middle;">
                                                    ...
                                                    <td style="color:red" class="pf62" style="text-align: center"></td>
                                                </tr>
                                                <td colspan="13"
                                                    style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
                                            ...
                                            <div class="table-container">
                                                <table border="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="color:red" class="pf63" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf64" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf65" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf66" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf67" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf68" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf69" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf70" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf71" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf72" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf73" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf74" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf75" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf76" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf77" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf78" style="text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1"
                                                            style="text-align:center;vertical-align:middle;">
                                                        ...
                                                        <td style="color:red" class="pf79" style="text-align: center"></td>
                                                    </tr>
                                                    <td colspan="13"
                                                        style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/serviceOrg_satr_add.js?v=1.5"
                type="text/javascript"></script>
        <script type="text/javascript"
        ...
        <script>
            ...
            $("label").click(function () {
                ...
                function sure() {
                    ...
                    if ($('select[name=starClass]').val()=="1") {
                        document.getElementById("r1").innerHTML = "—— ——";
                        document.getElementById("r2").innerHTML = "与全护理服务对象配备比例不低于1：8";
                        document.getElementById("r3").innerHTML = "初中或以上";
                        document.getElementById("r4").innerHTML = "—— ——";
                        document.getElementById("r5").innerHTML = "—— ——";
                        document.getElementById("r6").innerHTML = "≥30%";
                        document.getElementById("r7").innerHTML = "设置含就餐功能的区域";
                        document.getElementById("r8").innerHTML = "—— ——";
                        document.getElementById("r9").innerHTML = "包括但不限于出入院服务、生活照料服务、膳食服务、清洁卫生服务、洗涤服务、医疗护理服务、文化娱乐服务、心理／精神支持服务、安宁服务、委托服务";
                        $('#m1').addClass("t1");
                        $('#m4').addClass("t1");
                        $('#m5').addClass("t1");
                        $('#m8').addClass("t1");
                    } else if ($('select[name=starClass]').val()=="2") {
                        document.getElementById("r1").innerHTML = "—— ——";
                        document.getElementById("r2").innerHTML = "与全护理服务对象配备比例不低于1：7";
                        document.getElementById("r3").innerHTML = "初中或以上";
                        document.getElementById("r4").innerHTML = "—— ——";
                        document.getElementById("r5").innerHTML = "—— ——";
                        document.getElementById("r6").innerHTML = "≥35%";
                        document.getElementById("r7").innerHTML = "设置含就餐功能的区域";
                        document.getElementById("r8").innerHTML = "—— ——";
                        document.getElementById("r9").innerHTML = "包括但不限于出入院服务、生活照料服务、膳食服务、清洁卫生服务、洗涤服务、医疗护理服务、文化娱乐服务、心理／精神支持服务、安宁服务、委托服务";
                        $('#m1').addClass("t1");
                        ...
                        $('#m5').addClass("t1");
                        $('#m8').addClass("t1");
                    } else if ($('select[name=starClass]').val()=="3") {
                        document.getElementById("r1").innerHTML = "—— ——";
                        document.getElementById("r2").innerHTML = "与全护理服务对象配备比例不低于1：6";
                        document.getElementById("r3").innerHTML = "大专或以上";
                        document.getElementById("r4").innerHTML = "至少配有1名社会工作者指导开展社会工作服务";
                        document.getElementById("r5").innerHTML = "≥50%";
                        document.getElementById("r6").innerHTML = "≥40%";
                        document.getElementById("r7").innerHTML = "设置含就餐功能的区域，面积≥80平方米";
                        document.getElementById("r8").innerHTML = "设有康复区域，总面积≥50平方米";
                        document.getElementById("r9").innerHTML = "包括但不限于出入院服务、生活照料服务、膳食服务、清洁卫生服务、洗涤服务、医疗护理服务、文化娱乐服务、心理／精神支持服务、安宁服务、委托服务、康复服务";
                        $('#m1').addClass("t1");
                    } else if ($('select[name=starClass]').val()=="4") {
                        document.getElementById("r1").innerHTML = "不小于4000m2";
                        document.getElementById("r2").innerHTML = "与全护理服务对象配备比例不低于1：5";
                        document.getElementById("r3").innerHTML = "大专或以上";
                        document.getElementById("r4").innerHTML = "每200名老年人（不足200人按照200人计算）至少配有1名专职社会工作者指导开展社会工作服务";
                        document.getElementById("r5").innerHTML = "≥60%";
                        document.getElementById("r6").innerHTML = "≥45%";
                        document.getElementById("r7").innerHTML = "设置含就餐功能的区域，面积≥100平方米";
                        document.getElementById("r8").innerHTML = "设有康复区域，总面积≥100平方米";
                        document.getElementById("r9").innerHTML = "包括但不限于出入院服务、生活照料服务、膳食服务、清洁卫生服务、洗涤服务、医疗护理服务、文化娱乐服务、心理／精神支持服务、安宁服务、委托服务、康复服务、教育服务";
                    } else if ($('select[name=starClass]').val()=="5") {
                        document.getElementById("r1").innerHTML = "不小于6000m2";
                        document.getElementById("r2").innerHTML = "与全护理服务对象配备比例不低于1：4";
                        document.getElementById("r3").innerHTML = "大专或以上";
                        document.getElementById("r4").innerHTML = "每200名老年人（不足200人按照200人计算）至少配有1名专职社会工作者指导开展社会工作服务";
                        document.getElementById("r5").innerHTML = "≥90%";
                        document.getElementById("r6").innerHTML = "≥50%";
                        document.getElementById("r7").innerHTML = "设置含就餐功能的区域，面积≥150平方米";
                        document.getElementById("r8").innerHTML = "设有康复区域，总面积≥150平方米";
                        document.getElementById("r9").innerHTML = "包括但不限于出入院服务、生活照料服务、膳食服务、清洁卫生服务、洗涤服务、医疗护理服务、文化娱乐服务、心理／精神支持服务、安宁服务、委托服务、康复服务、教育服务";
                    }
                }
