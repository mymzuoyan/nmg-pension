...
<tiles:insertDefinition name="tiles.template.admin.layout">
    ...
    <tiles:putAttribute name="page_content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <shiro:hasPermission name="pension-service-manager-communityPensionStarsList-assess-update">
                ...
                <div class="portlet ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">社区养老服务站星级评定标准列表详细列表</span>
                        </div>
                    </div>
                            ...
                            <form id="starRate" class="form-body" id="addGovBuy">
                                ...
                                <table  class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="6"
                                            ...
                                            安全部分总评分数(总分50):<span id="all"></span>
                                        </td>
                                    </tr>
                                </table>
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="6"
                                            style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
                                            服务部分总评分数(总分300):<span id="all2"></span>
                                        </td>
                                    </tr>
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="text-align: center">3</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore3" name="manageScore1"
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>3 || value.length >1) value=0"
                                                          class="in34" max="3" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：一类档案记录不规范按照现场查勘情况扣1-3分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>3 || value.length >1) value=0"
                                                          class="in36" max="3" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：对投诉未处理、记录、整改、反馈，按照现场查勘情况扣1-3分；未指定专人负责或无相关记录扣3分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">6</td>
                                        <td cospan="5">未未设多渠道的投诉途径不得分；对投诉未处理、记录、整改、反馈，按照现场查勘情况扣1-3分；未指定专人负责或无相关记录扣3分
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>3 || value.length >1) value=0"
                                                          class="in37" max="3" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：记录不规范按照现场查勘情况扣1-3分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">6</td>
                                    ...
                                    <tr>
                                        <td colspan="6"
                                            style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
                                            管理部分总评分数(总分70):<span id="all3"></span>
                                        </td>
                                    </tr>
                                </table>
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="6"
                                            style="text-align: right;vertical-align: middle;font-size: 18px" class="caption-subject font-red bold uppercase">
                                            设施部分总评分数(总分80):<span id="all4"></span>
                                        </td>
                                    </tr>
                                </table>
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td colspan="6"
                                            ...
                                            社区养老服务站星级评定标准总评评分(总分500):<span id="all5"></span>
                                        </td>
                                    </tr>
                                </table>
                            </form>
  ...
  <%--      <script type="text/javascript"
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/community_pension_stars.js?v=1.3"
            ...
            jQuery(document).ready(function () {
                ...
                $("label").click(function () {
                   ...
                   /* 服务部分总评分数*/
                    ...
                    $(this).parent().parent().find(".pf34").html(parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val()>0?parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val():0);
                     num34=parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val()>0?parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val():0;
                    $(".in34").blur(function () {
                        $(".pf34").html(parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val()>0?parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val():0);
                        num34=parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val()>0?parseInt(arr34[0]) + parseInt(arr34[1])-$(".in34").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf36").html(parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val()>0?parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val():0);
                     num36=parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val()>0?parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val():0;
                    $(".in36").blur(function () {
                        $(".pf36").html(parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val()>0?parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val():0);
                        num36=parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val()>0?parseInt(arr36[0]) + parseInt(arr36[1])-$(".in36").val():0;
                    })
                    ...
                    /* 管理部分总评分数*/
                    $(".in34,.in36,.in37").blur(function () {
                       /* $(this).parent().click();*/
                         $("#all3").html(parseInt(arr31[0]) + parseInt(arr31[1])+parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+num34+parseInt(arr35[0])+num36+num37+parseInt(arr38[0]) + parseInt(arr38[1])+ parseInt(arr39[0]));
                    })
                    $("#all3").html(parseInt(arr31[0]) + parseInt(arr31[1])+parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+num34+parseInt(arr35[0])+num36+num37+parseInt(arr38[0]) + parseInt(arr38[1])+ parseInt(arr39[0]));
                  ...
                  /*  $(".label43").click(function () {
                    ...
                    $(".in34,.in36,.in37").blur(function () {
                        /* $(this).parent().click();*/
                        $("#all5").html(parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+parseInt(arr7[0]) + parseInt(arr7[1])+parseInt(arr8[0])+parseInt(arr9[0])+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0]) + parseInt(arr15[1])+parseInt(arr21[0]) + parseInt(arr21[1])+ parseInt(arr22[0])+parseInt(arr23[0])+parseInt(arr24[0]) + parseInt(arr24[1])+parseInt(arr25[0]) + parseInt(arr25[1]) + parseInt(arr25[2]) + parseInt(arr25[3]) + parseInt(arr25[4])+parseInt(arr26[0])+parseInt(arr27[0])+parseInt(arr28[0])+parseInt(arr31[0]) + parseInt(arr31[1])+parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+num34+parseInt(arr35[0])+num36+num37+parseInt(arr38[0]) + parseInt(arr38[1])+ parseInt(arr39[0])+parseInt(arr41[0]) + parseInt(arr41[1]) + parseInt(arr41[2]) + parseInt(arr41[3])+parseInt(arr42[0])+ parseInt(arr43[0])+parseInt(arr43[1])+parseInt(arr43[2])+parseInt(arr44[0]) + parseInt(arr44[1])+parseInt(arr45[0]) + parseInt(arr45[1])+parseInt(arr46[0]) + parseInt(arr46[1])+parseInt(arr47[0])+parseInt(arr48[0]) + parseInt(arr48[1])+parseInt(arr49[0]) + parseInt(arr49[1])+parseInt(arr50[0]) + parseInt(arr50[1]) + parseInt(arr50[2]) + parseInt(arr50[3])+ parseInt(arr50[4])+ parseInt(arr50[5])+ parseInt(arr50[6])+ parseInt(arr50[7]));
...
*/
                ...
                /**管理部分*/
                var gltotal=parseInt(arr31[0]) + parseInt(arr31[1])+parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+num34+parseInt(arr35[0])+num36+num37+parseInt(arr38[0]) + parseInt(arr38[1])+ parseInt(arr39[0]);
                /**设施部分*/
                ...
                $.post(window.apppath + "/admin/api/institution/org/communityPensionStarsAssess/updata", {
