            ...
            <div class="col-md-12">
                <div class="portlet ">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-red-sunglo bold uppercase">从业人员培训信息新增</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <div class="form-horizontal">
                            ...
                            <form class="form-body" id="addGovBuy">
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="app_list_search_td">
                                            <input type="text" id="trainingTime" name="trainingTime" value=""
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="app_list_search_td" >
                                            <input type="text" class="form-control" id="trainingInstitutions" name="trainingInstitutions" value="" placeholder="证书名称"
                                                   maxlength="18"/>
                                        </td>
                                        <td colspan="1" style="text-align:center;vertical-align:middle;" class="app_list_search_caption">
                                        ...
                                        <td colspan="2" class="app_list_search_td" >
                                            <input type="text" class="form-control" id="trainingContents" name="trainingContents" value="" placeholder="证书名称"
                                                   maxlength="18"/>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn blue trainAdd">保存</button>
                                <span id="labelmsg" class="label"></span>
                                <button onclick="window.parent.closeTab('tab_train_add')" class="btn btn-default">返回
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                function trainAdd() {
                    $.post(window.apppath + "/admin/api/user/fuwu/trainAdd", {
