...
<tiles:insertDefinition name="tiles.template.admin.layout">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    <div class="portlet-body">
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="SubsidyApply.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                        ...
                        <shior:hasPermission name="entry_subsidy_list_verity">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/entry_subsidy_list.js"
                type="text/javascript"></script>
