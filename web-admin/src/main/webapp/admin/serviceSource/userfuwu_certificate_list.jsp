...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">从业人员证书信息管理列表</span>
                        </div>
                        <div class="tools">
                            <shior:hasPermission name="employee-certificate-add">
                                <div style="float: left">
                                    <a data="${pageContext.request.contextPath}/admin/user/fuwu/certificateAdd"
                        ...
                        <form id="serviceOrg-form" name="serviceOrg-form">
                            <table class="table table-bordered table-hover table-condensed table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;">
                                        <input name="certificateName" placeholder="请输入证书名称" value=""
                                               class="form-control"
                                               style="width: 100%">
                                    <td style="text-align:center;vertical-align:middle;">
                                        发证时间
                                    ...
                                    <td style="text-align:center;vertical-align:middle;">
                                        <input name="issuingTime" placeholder="请选择发证时间" value=""
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="UserFuWuCertificateList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
                                <shiro:hasPermission name="certificate-delete">
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/userfuwu_certificate_list.js?v=2.6"
                type="text/javascript"></script>
        <script type="text/javascript"
