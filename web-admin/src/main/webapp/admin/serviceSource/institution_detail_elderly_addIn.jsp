...
<tiles:insertDefinition name="tiles.template.admin.layout">
                            ...
                            <form class="form-body" id="addGovBuy">
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="app_list_search_td" >
                                            <input type="hidden" value="${id}" id="serviceOrgId" name="serviceOrgId">
                                    ...
                                    <tr>
                                        ...
                                        <td class="app_list_search_td">
                                            <input type="text" id="bedNumber" name="bedNumber" value=""
                                                   class="form-control"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="app_list_search_td">
                                            <input type="text" id="bedInfo" name="bedInfo" value=""
                                                   class="form-control"/>
                                        </td>
                                        <td class="app_list_search_caption">
                                            床位类型
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script>
            ...
            function addGovbuy() {
                    $.post(window.apppath + "/admin/api/institution/elderly/detailAddInOut", {
