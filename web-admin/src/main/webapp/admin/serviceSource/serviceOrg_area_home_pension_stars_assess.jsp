...
<tiles:insertDefinition name="tiles.template.admin.layout">
    <tiles:putAttribute name="page_title">
        <title>区域性居家养老服务中心星级评定标准详情页</title>
    </tiles:putAttribute>
    ...
    <tiles:putAttribute name="page_content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <shiro:hasPermission name="pension-service-manager-areaHomePensionStarsList-assess-update">
                ...
                <div class="portlet ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">区域性居家养老服务中心星级评定详细列表</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body form">
                        <div class="form-horizontal">
                            ...
                            <!-- PERSONAL INFO TAB -->
                            <form id="starRate" class="form-body" id="addGovBuy">
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                      ...
                                      <%--  <td style="width:10%;text-align:center;vertical-align:middle;">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <input type="text" id="area" name="areaName"
                                                               ...
                                                               style="width: 100%" class="form-control" value="${star.area}">
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:if>
                                        ...
                                        <td class="app_list_search_td">
                                            <input width="50" type="text" id="organizationNames"
                                                   name="organizationNames" value="${star.organizationNames}" placeholder="请输入机构名称"
                                                   class="form-control"/>
                                            <input type="hidden" name="Id" id="Id"
                                                   value="${star.id}">
                                            ...
                                            <input type="hidden" name="starRating" id="starRating"
                                                   value="${star.starRating}">
                                            <input type="hidden" name="totalScore" id="totalScore"
                                                   value="${star.totalScore}">

                                            <input type="hidden" name="serviceOrgId" id="serviceOrgId"
                                                   value="${star.serviceOrgId}">
                                            <input type="hidden" name="pgType" id="pgType"
                                                   value="${star.pgType}">
                                            <input type="hidden" name="applicationStatus" id="applicationStatus"
                                                   value="${star.applicationStatus}">
                                        </td>
                                          <td class="app_list_search_caption"
                                              style="width:10%;text-align:center;vertical-align:middle;">
                                              评定时间<span style="color:red"> *</span>
                                          </td>
                                          <td class="app_list_search_td">
                                              <input type="text" id="applicationTime" name="applicationTime" value="${star.applicationTime}"
                                                     placeholder="请选择评定时间"
                                  ...
                                  <%--  <tr>
                                       &lt;%&ndash; <td class="app_list_search_caption"
                                            style="width:10%;text-align:center;vertical-align:middle;">
                                        ...
                                        class="form-control date-picker"/>
                                           ...
                                           <td style="width: 10%; vertical-align:middle;text-align: center"><font
                                                   color=""></font>星级评定
                                           </td>
                                           <td width="25%">
                                               <select id="starRating" class="form-control" disabled="false"
                                                       name="starRating">
                                ...
                                <table  class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore1" name="safetyScore1"
                                                   value="${star.safetyScore1}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore2" name="safetyScore2"
                                                   value="${star.safetyScore2}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore3" name="safetyScore3"
                                                   value="${star.safetyScore3}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore4" name="safetyScore4"
                                                   value="${star.safetyScore4}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>4 || value.length >1) value=0"
                                                          class="in4" max="4" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：出入口有效宽度小于1.20m扣1分,出入口处平台与建筑室外无缓步台阶和轮椅坡道过渡扣2分，起止处无异色警示条扣1分</span></label><br>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore5" name="safetyScore5"
                                                   value="${star.safetyScore5}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore6" name="safetyScore6"
                                                   value="${star.safetyScore6}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore7" name="safetyScore7"
                                                   value="${star.safetyScore7}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>3 || value.length >1) value=0"
                                                          class="in7" max="3" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：记录不规范不完整按照现场查勘情况扣1-3分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">8</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore8" name="safetyScore8"
                                                   value="${star.safetyScore8}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore9" name="safetyScore9"
                                                   value="${star.safetyScore9}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>2 || value.length >1) value=0"
                                                          class="in9" max="2" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：设置不规范按照现场勘查情况扣1-2分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">5</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore10" name="safetyScore10"
                                                   value="${star.safetyScore10}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore11" name="safetyScore11"
                                                   value="${star.safetyScore11}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore12" name="safetyScore12"
                                                   value="${star.safetyScore12}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore13" name="safetyScore13"
                                                   value="${star.safetyScore13}">
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" id="safetyScore14" name="safetyScore14"
                                               value="${star.safetyScore14}">
                                        <td cospan="5">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore15" name="safetyScore15"
                                                   value="${star.safetyScore15}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore16" name="safetyScore16"
                                                   value="${star.safetyScore16}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>24 || value.length >2) value=0"
                                                          class="in16" max="24" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：生熟未分开扣6分；成品半成品未分开制作、存储扣6分,项食品留样时间不足48小时，扣6分；食品留样不全，扣3分；食品留样记录不规范不完整，扣3分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">30</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore17" name="safetyScore17"
                                                   value="${star.safetyScore17}">
                                            <label><input type="checkbox" name="input17" value="5"
                                                          class="in"/>建立特种设施、设备台帐（电梯、空调、锅炉等）</label><br>
                                            <label><input type="checkbox" name="input17" value="5"
                                                          class="in"/>特种设备定期接受专业单位检验</label><br>
                                            <label><input type="number" value="0" oninput="if(value>5 || value.length >1) value=0"
                                                          class="in17" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：资料不全或欠规范以现场查勘情况扣1-5分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore18" name="safetyScore18"
                                                   value="${star.safetyScore18}">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore19" name="safetyScore19"
                                                   value="${star.safetyScore19}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>2 || value.length >1) value=0"
                                                          class="in19" max="2" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：图片及文字记录不规范不完整，按照现场查勘情况扣分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">5</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore20" name="safetyScore20"
                                                   value="${star.safetyScore20}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>9 || value.length >1) value=0"
                                                          class="in20" max="9" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：安全工作自查记录不规范不完整按照现场查勘情况扣1-5分；自查项目未全覆盖每少一项应自查项目扣1分，最多扣5分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            <input type="hidden" id="safetyScore210" name="safetyScore210"
                                                   value="${star.safetyScore20}">
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="text-align: center">1</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore1" name="serviceScore1"
                                                   value="${star.serviceScore1}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in21" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">2</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore2" name="serviceScore2"
                                                   value="${star.serviceScore2}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in22" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">60</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">3</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore3" name="serviceScore3"
                                                   value="${star.serviceScore3}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in23" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">60</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">4</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore4" name="serviceScore4"
                                                   value="${star.serviceScore4}">
                                            ...
                                            <label><input type="checkbox" name="input24" value="40"
                                                          class="in"/>上门为老人提供助浴服务</label><br>
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in24" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">60</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">5</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore5" name="serviceScore5"
                                                   value="${star.serviceScore5}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in25" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">60</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">6</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore6" name="serviceScore6"
                                                   value="${star.serviceScore6}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in26" max="59" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">60</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">7</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore7" name="serviceScore7"
                                                   value="${star.serviceScore7}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>29 || value.length >2) value=0"
                                                          class="in27" max="29" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">30</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">8</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore8" name="serviceScore8"
                                                   value="${star.serviceScore8}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>29 || value.length >2) value=0"
                                                          class="in28" max="29" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">30</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">9</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore9" name="serviceScore9"
                                                   value="${star.serviceScore9}">
                                            ...
                                            <label><input type="checkbox" name="input29" value="10"
                                                          class="in"/>有相应人员开展过服务并有详细服务记录</label>
                                            <label><input type="number" value="0" oninput="if(value>29 || value.length >2) value=0"
                                                          class="in29" max="29" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">30</td>
                                        <td cospan="5">服务内容：有相应人员开展过服务并有详细服务记录，得10分
                                    ...
                                    <tr>
                                        <td style="text-align: center">10</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore10" name="serviceScore10"
                                                   value="${star.serviceScore10}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">11</td>
                                        <td cospan="5">
                                            <input type="hidden" id="serviceScore11" name="serviceScore11"
                                                   value="${star.serviceScore11}">
                                            <label><input type="checkbox" name="input310" value="30"
                                                          class="in"/>上门服务次数</label><br>
                                            <label><input type="number" value="0" oninput="if(value>59 || value.length >2) value=0"
                                                          class="in310" max="29" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">30</td>
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="text-align: center">1</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore1" name="manageScore1"
                                                   value="${star.manageScore1}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>29 || value.length >2) value=0"
                                                          class="in31" max="29" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                    ...
                                    <tr>
                                        <td style="text-align: center">2</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore2" name="manageScore2"
                                                   value="${star.manageScore2}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">3</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore3" name="manageScore3"
                                                   value="${star.manageScore3}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">4</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore4" name="manageScore4"
                                                   value="${star.manageScore4}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">5</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore5" name="manageScore5"
                                                   value="${star.manageScore5}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>4 || value.length >1) value=0"
                                                          class="in35" max="4" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填):一类档案记录不规范按照现场查勘情况扣1-4分</span></label><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">6</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore6" name="manageScore6"
                                                   value="${star.manageScore6}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">7</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore7" name="manageScore7"
                                                   value="${star.manageScore7}">
                                            <label><input type="checkbox" name="input37" value="10"
                                                          class="in"/>建立员工考核制度，制订各部门、各岗位考核细则，确保各职能部门每月考核且有记录可查</label><br>
                                            <label><input type="number" value="0" oninput="if(value>9 || value.length >1) value=0"
                                                          class="in37" max="9" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填):考核制度及实施考核不规范视情况扣分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">8</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore8" name="manageScore8"
                                                   value="${star.manageScore8}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>5 || value.length >1) value=0"
                                                          class="in38" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填):对投诉未处理、记录、整改、反馈，按照现场查勘情况扣1-5分,未指定专人负责或无相关记录扣5分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">9</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore9" name="manageScore9"
                                                   value="${star.manageScore9}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>5 || value.length >1) value=0"
                                                          class="in39" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填):记录不规范按照现场查勘情况扣1-5分</span></label><br>
                                    ...
                                    <tr>
                                        <td style="text-align: center">10</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore10" name="manageScore10"
                                                   value="${star.manageScore10}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">11</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore11" name="manageScore11"
                                                   value="${star.manageScore11}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">12</td>
                                        <td cospan="5">
                                            <input type="hidden" id="manageScore12" name="manageScore12"
                                                   value="${star.manageScore12}">
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="text-align: center">1</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore1" name="facilityScore1"
                                                   value="${star.facilityScore1}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">2</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore2" name="facilityScore2"
                                                   value="${star.facilityScore2}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">3</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore3" name="facilityScore3"
                                                   value="${star.facilityScore3}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">4</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore4" name="facilityScore4"
                                                   value="${star.facilityScore4}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">5</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore5" name="facilityScore5"
                                                   value="${star.facilityScore5}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">6</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore6" name="facilityScore6"
                                                   value="${star.facilityScore6}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">7</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore7" name="facilityScore7"
                                                   value="${star.facilityScore7}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">8</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore8" name="facilityScore8"
                                                   value="${star.facilityScore8}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">9</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore9" name="facilityScore9"
                                                   value="${star.facilityScore9}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">10</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore10" name="facilityScore10"
                                                   value="${star.facilityScore10}">
                                            <label><input type="checkbox" name="input50" value="10"
                                                          class="in"/>设有医疗机构或医疗保健用房</label><br>
                                            <label><input type="number" value="0" oninput="if(value>4 || value.length >1) value=0"
                                                          class="in50" max="4" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">11</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore11" name="facilityScore11"
                                                   value="${star.facilityScore11}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">12</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore12" name="facilityScore12"
                                                   value="${star.facilityScore12}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">13</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore13" name="facilityScore13"
                                                   value="${star.facilityScore13}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">14</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore14" name="facilityScore14"
                                                   value="${star.facilityScore14}">
                                    ...
                                    <tr>
                                        <td style="text-align: center">15</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore15" name="facilityScore15"
                                                   value="${star.facilityScore15}">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>14 || value.length >1) value=0"
                                                          class="in55" max="14" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">15</td>
                                    ...
                                    <tr>
                                        <td style="text-align: center">16</td>
                                        <td cospan="5">
                                            <input type="hidden" id="facilityScore16" name="facilityScore16"
                                                   value="${star.facilityScore16}">
                            ...
                            <div id="update" class="modal-footer">
                                <button type="button"  class="btn blue addGovBuy" disabled name="updateStar">保存</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn blue"
                                onclick="CommunityPensionStarsList.getAreaName()">
                            确定
                        </button>
                        <button type="button"
                                class="btn default"
...
<%--        <script type="text/javascript"
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/area_home_pension_stars.js?v=1.3"
        ...
        <script>
            ...
            jQuery(document).ready(function () {
                ...
                $("label").click(function () {
                    ...
                    $(this).parent().parent().find(".pf4").html(parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val()>0?parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val():0);
                    num4=parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val()>0?parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val():0;
                    $(".in4").blur(function () {
                        $(".pf4").html(parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val()>0?parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val():0);
                        num4=parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val()>0?parseInt(arr4[0]) + parseInt(arr4[1]) + parseInt(arr4[2])-$(".in4").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf7").html(parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val()>0?parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val():0);
                    num7=parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val()>0?parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val():0;
                    $(".in7").blur(function () {
                        $(".pf7").html(parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val()>0?parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val():0);
                        num7=parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val()>0?parseInt(arr7[0]) + parseInt(arr7[1])-$(".in7").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf9").html(parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val()>0?parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val():0);

                    num9=parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val()>0?parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val():0;
                    $(".in9").blur(function () {
                        $(".pf9").html(parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val()>0?parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val():0);
                        num9=parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val()>0?parseInt(arr9[0])+parseInt(arr9[1])-$(".in9").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf16").html(parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val()>0?parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val():0);
                    num16=parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val()>0?parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val():0;
                    $(".in16").blur(function () {
                        $(".pf16").html(parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val()>0?parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val():0);
                        num16=parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val()>0?parseInt(arr16[0])+parseInt(arr16[1])+parseInt(arr16[2])-$(".in16").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf17").html(parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val()>0?parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val():0);

                    num17=parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val()>0?parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val():0;
                    $(".in17").blur(function () {
                        $(".pf17").html(parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val()>0?parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val():0);
                        num17=parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val()>0?parseInt(arr17[0])+parseInt(arr17[1])-$(".in17").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf19").html(parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val()>0?parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val():0);

                    num19=parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val()>0?parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val():0;
                    $(".in19").blur(function () {
                        $(".pf19").html(parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val()>0?parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val():0);
                        num19=parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val()>0?parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf20").html(parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val()>0?parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val():0);

                    num20=parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val()>0?parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val():0;
                    $(".in20").blur(function () {
                        $(".pf20").html(parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val()>0?parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val():0);
                        num20=parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val()>0?parseInt(arr20[0])+parseInt(arr20[1])-$(".in20").val():0;
                    })
                    ...
                    $(".in4,.in7,.in9,.in16,.in17,.in19,.in20").blur(function () {
                        $("#all").html(parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+num4+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+num7+parseInt(arr8[0])+num9+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+ parseInt(arr12[2])+ parseInt(arr12[3])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0])+num16+num17+parseInt(arr18[0])+num19+num20+parseInt(arr210[0])+parseInt(arr210[1]));
                    })
                    /*安全部分总评分数*/
                    $("#all").html(parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+num4+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+num7+parseInt(arr8[0])+num9+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+ parseInt(arr12[2])+ parseInt(arr12[3])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0])+num16+num17+parseInt(arr18[0])+num19+num20+parseInt(arr210[0])+parseInt(arr210[1]));
                    ...
                    $(this).parent().parent().find(".pf21").html(parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val()>0?parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val():0);

                    num21=parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val()>0?parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val():0;
                    $(".in21").blur(function () {
                        $(".pf21").html(parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val()>0?parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val():0);
                        num21=parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val()>0?parseInt(arr21[0]) + parseInt(arr21[1])-$(".in21").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf22").html(parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val()>0?parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val():0);

                    num22=parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val()>0?parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val():0;
                    $(".in22").blur(function () {
                        $(".pf22").html(parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val()>0?parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val():0);
                        num22=parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val()>0?parseInt(arr22[0])+parseInt(arr22[1])+parseInt(arr22[2])+parseInt(arr22[3])-$(".in22").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf23").html(parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val()>0?parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val():0);

                    num23=parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val()>0?parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val():0;
                    $(".in23").blur(function () {
                        $(".pf23").html(parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val()>0?parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val():0);
                        num23=parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val()>0?parseInt(arr23[0])+parseInt(arr23[1])+parseInt(arr23[2])+parseInt(arr23[3])-$(".in23").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf24").html(parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val()>0?parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val():0);

                    num24=parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val()>0?parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val():0;
                    $(".in24").blur(function () {
                        $(".pf24").html(parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val()>0?parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val():0);
                        num24=parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val()>0?parseInt(arr24[0]) + parseInt(arr24[1])-$(".in24").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf25").html(parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val()>0?parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val():0);

                    num25=parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val()>0?parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val():0;
                    $(".in25").blur(function () {
                        $(".pf25").html(parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val()>0?parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val():0);
                        num25=parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val()>0?parseInt(arr25[0]) + parseInt(arr25[1])-$(".in25").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf26").html(parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val()>0?parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val():0);

                    num26=parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val()>0?parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val():0;
                    $(".in26").blur(function () {
                        $(".pf26").html(parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val()>0?parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val():0);
                        num26=parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val()>0?parseInt(arr26[0])+parseInt(arr26[1])-$(".in26").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf27").html(parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val()>0?parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val():0);

                    num27=parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val()>0?parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val():0;
                    $(".in27").blur(function () {
                        $(".pf27").html(parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val()>0?parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val():0);
                        num27=parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val()>0?parseInt(arr27[0])+parseInt(arr27[1])-$(".in27").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf28").html(parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val()>0?parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val():0);

                    num28=parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val()>0?parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val():0;
                    $(".in28").blur(function () {
                        $(".pf28").html(parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val()>0?parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val():0);
                        num28=parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val()>0?parseInt(arr28[0])+parseInt(arr28[1])-$(".in28").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf29").html(parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val()>0?parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val():0);

                    num29=parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val()>0?parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val():0;
                    $(".in29").blur(function () {
                        $(".pf29").html(parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val()>0?parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val():0);
                        num29=parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val()>0?parseInt(arr29[0])+parseInt(arr29[1])-$(".in29").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf310").html(parseInt(arr310[0])-$(".in310").val()>0?parseInt(arr310[0])-$(".in310").val():0);

                    num310=parseInt(arr310[0])-$(".in310").val()>0?parseInt(arr310[0])-$(".in310").val():0;
                    $(".in310").blur(function () {
                        $(".pf310").html(parseInt(arr310[0])-$(".in310").val()>0?parseInt(arr310[0])-$(".in310").val():0);
                        num310=parseInt(arr310[0])-$(".in310").val()>0?parseInt(arr310[0])-$(".in310").val():0;
                    })

                    $(".in21,.in22,.in23,.in24,.in25,.in26,.in27,.in28,.in29,.in310").blur(function () {
                        $("#all2").html(num21+ num22+num23+num24+num25 +num26+num27+num28+num29+parseInt(arr30[0])+num310);
                   ...
                   /* 服务部分总评分数*/
                    ...
                    $(this).parent().parent().find(".pf31").html(parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val()>0?parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val():0);

                    num31=parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val()>0?parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val():0;
                    $(".in31").blur(function () {
                        $(".pf31").html(parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val()>0?parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val():0);
                        num31=parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val()>0?parseInt(arr31[0]) + parseInt(arr31[1])+ parseInt(arr31[2])+ parseInt(arr31[3])+ parseInt(arr31[4])-$(".in31").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf35").html(parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val()>0?parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val():0);

                    num35=parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val()>0?parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val():0;
                    $(".in35").blur(function () {
                        $(".pf35").html(parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val()>0?parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val():0);
                        num35=parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val()>0?parseInt(arr35[0])+parseInt(arr35[1])-$(".in35").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf37").html(parseInt(arr37[0])-$(".in37").val()>0?parseInt(arr37[0])-$(".in37").val():0);

                    num37=parseInt(arr37[0])-$(".in37").val()>0?parseInt(arr37[0])-$(".in37").val():0;
                    $(".in37").blur(function () {
                        $(".pf37").html(parseInt(arr37[0])-$(".in37").val()>0?parseInt(arr37[0])-$(".in37").val():0);
                        num37=parseInt(arr37[0])-$(".in37").val()>0?parseInt(arr37[0])-$(".in37").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf38").html(parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val()>0?parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val():0);

                    num38=parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val()>0?parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val():0;
                    $(".in38").blur(function () {
                        $(".pf38").html(parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val()>0?parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val():0);
                        num38=parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val()>0?parseInt(arr38[0]) + parseInt(arr38[1])-$(".in38").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf39").html(parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val()>0?parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val():0);

                    num39=parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val()>0?parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val():0;
                    $(".in39").blur(function () {
                        $(".pf39").html(parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val()>0?parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val():0);
                        num39=parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val()>0?parseInt(arr39[0])+parseInt(arr39[1])-$(".in39").val():0;
                    })
                    ...
                    $(".in31,.in35,.in37,.in38,.in39").blur(function () {
                        /* $(this).parent().click();*/
                        $("#all3").html(num31 +parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+parseInt(arr34[0]) + parseInt(arr34[1])+num35+parseInt(arr36[0]) +num37+num38+ num39+ parseInt(arr40[0])+ parseInt(arr40[1])+ parseInt(arr410[0])+ parseInt(arr420[0]));
                    })
                    ...
                    $(this).parent().parent().find(".pf50").html(parseInt(arr50[0])-$(".in50").val()>0?parseInt(arr50[0])-$(".in50").val():0);

                    num50=parseInt(arr50[0])-$(".in50").val()>0?parseInt(arr50[0])-$(".in50").val():0;
                    $(".in50").blur(function () {
                        $(".pf50").html(parseInt(arr50[0])-$(".in50").val()>0?parseInt(arr50[0])-$(".in50").val():0);
                        num50=parseInt(arr50[0])-$(".in50").val()>0?parseInt(arr50[0])-$(".in50").val():0;
                    })
                    ...
                    $(this).parent().parent().find(".pf55").html(parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val()>0?parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val():0);

                    num55=parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val()>0?parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val():0;
                    $(".in55").blur(function () {
                        $(".pf55").html(parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val()>0?parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val():0);
                        num55=parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val()>0?parseInt(arr55[0])+parseInt(arr55[1])-$(".in55").val():0;
                    })
                    ...
                    $(".in50,.in55").blur(function () {
                        /* $(this).parent().click();*/
                        $("#all4").html(parseInt(arr41[0]) + parseInt(arr41[1]) + parseInt(arr41[2]) + parseInt(arr41[3])+parseInt(arr42[0])+ parseInt(arr43[0])+parseInt(arr43[1])+parseInt(arr43[2])+parseInt(arr44[0]) + parseInt(arr44[1])+parseInt(arr45[0]) + parseInt(arr45[1])+ parseInt(arr45[2])+parseInt(arr46[0]) + parseInt(arr46[1])+parseInt(arr47[0])+parseInt(arr47[1])+parseInt(arr48[0]) + parseInt(arr48[1])+parseInt(arr49[0]) + parseInt(arr49[1])+num50+parseInt(arr51[0])+parseInt(arr52[0])+parseInt(arr53[0])+parseInt(arr53[1])+parseInt(arr54[0])+parseInt(arr54[1])+parseInt(arr54[2])+parseInt(arr54[3])+parseInt(arr54[4])+num55+parseInt(arr56[0])+parseInt(arr56[1]));
                    })
                    ...
                    /*社区养老服务站星级评定标准总评分数*/
                    $(".in4,.in7,.in9,.in16,.in17,.in19,.in20,.in21,.in22,.in23,.in24,.in25,.in26,.in27,.in28,.in29,.in310,.in31,.in35,.in37,.in38,.in39,.in50,.in55").blur(function () {

                        $("#all5").html(parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+num4+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+num7+parseInt(arr8[0])+num9+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+ parseInt(arr12[2])+ parseInt(arr12[3])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0])+num16+num17+parseInt(arr18[0])+num19+num20+parseInt(arr210[0])+parseInt(arr210[1])+num21+ num22+num23+num24+num25 +num26+num27+num28+num29+parseInt(arr30[0])+num310+num31 +parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+parseInt(arr34[0]) + parseInt(arr34[1])+num35+parseInt(arr36[0]) +num37+num38+ num39+ parseInt(arr40[0])+ parseInt(arr40[1])+ parseInt(arr410[0])+ parseInt(arr420[0])+parseInt(arr41[0]) + parseInt(arr41[1]) + parseInt(arr41[2]) + parseInt(arr41[3])+parseInt(arr42[0])+ parseInt(arr43[0])+parseInt(arr43[1])+parseInt(arr43[2])+parseInt(arr44[0]) + parseInt(arr44[1])+parseInt(arr45[0]) + parseInt(arr45[1])+ parseInt(arr45[2])+parseInt(arr46[0]) + parseInt(arr46[1])+parseInt(arr47[0])+parseInt(arr47[1])+parseInt(arr48[0]) + parseInt(arr48[1])+parseInt(arr49[0]) + parseInt(arr49[1])+num50+parseInt(arr51[0])+parseInt(arr52[0])+parseInt(arr53[0])+parseInt(arr53[1])+parseInt(arr54[0])+parseInt(arr54[1])+parseInt(arr54[2])+parseInt(arr54[3])+parseInt(arr54[4])+num55+parseInt(arr56[0])+parseInt(arr56[1]));
                    })
            ...
            function modify() {
                $("#starRate").find("input").prop("disabled", false);//找到form表单下的所有input标签并置为可编辑
            ...
            function init() {
                $("#starRate").find("input").prop("disabled", true);//找到form表单下的所有input标签并置为不可编辑
...
*/
                ...
                /**/
                var totalfs = parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+num4+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+num7+parseInt(arr8[0])+num9+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+ parseInt(arr12[2])+ parseInt(arr12[3])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0])+num16+num17+parseInt(arr18[0])+num19+num20+parseInt(arr210[0])+parseInt(arr210[1])+num21+ num22+num23+num24+num25 +num26+num27+num28+num29+parseInt(arr30[0])+num310+num31 +parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+parseInt(arr34[0]) + parseInt(arr34[1])+num35+parseInt(arr36[0]) +num37+num38+ num39+ parseInt(arr40[0])+ parseInt(arr40[1])+ parseInt(arr410[0])+ parseInt(arr420[0])+parseInt(arr41[0]) + parseInt(arr41[1]) + parseInt(arr41[2]) + parseInt(arr41[3])+parseInt(arr42[0])+ parseInt(arr43[0])+parseInt(arr43[1])+parseInt(arr43[2])+parseInt(arr44[0]) + parseInt(arr44[1])+parseInt(arr45[0]) + parseInt(arr45[1])+ parseInt(arr45[2])+parseInt(arr46[0]) + parseInt(arr46[1])+parseInt(arr47[0])+parseInt(arr47[1])+parseInt(arr48[0]) + parseInt(arr48[1])+parseInt(arr49[0]) + parseInt(arr49[1])+num50+parseInt(arr51[0])+parseInt(arr52[0])+parseInt(arr53[0])+parseInt(arr53[1])+parseInt(arr54[0])+parseInt(arr54[1])+parseInt(arr54[2])+parseInt(arr54[3])+parseInt(arr54[4])+num55+parseInt(arr56[0])+parseInt(arr56[1]);
                /*安全部分*/
                var aqtotal=parseInt(arr1[0]) + parseInt(arr2[0]) + parseInt(arr2[1])+ parseInt(arr3[0]) + parseInt(arr3[1]) + parseInt(arr3[2])+num4+parseInt(arr5[0]) + parseInt(arr5[1])+parseInt(arr6[0]) + parseInt(arr6[1]) + parseInt(arr6[2])+num7+parseInt(arr8[0])+num9+parseInt(arr10[0])+parseInt(arr11[0]) + parseInt(arr11[1]) + parseInt(arr11[2]) + parseInt(arr11[3])+parseInt(arr12[0]) + parseInt(arr12[1])+ parseInt(arr12[2])+ parseInt(arr12[3])+parseInt(arr13[0])+parseInt(arr14[0])+parseInt(arr15[0])+num16+num17+parseInt(arr18[0])+num19+num20+parseInt(arr210[0])+parseInt(arr210[1]);
                /* 服务部分*/
                var fwtotal=num21+ num22+num23+num24+num25 +num26+num27+num28+num29+parseInt(arr30[0])+num310;
                /**管理部分*/
                var gltotal=num31 + parseInt(arr32[0])+parseInt(arr33[0]) + parseInt(arr33[1]) + parseInt(arr33[2]) + parseInt(arr33[3]) + parseInt(arr33[4])+parseInt(arr34[0]) + parseInt(arr34[1])+num35+parseInt(arr36[0]) +num37+num38+ num39+ parseInt(arr40[0])+ parseInt(arr40[1])+ parseInt(arr410[0])+ parseInt(arr420[0]);
                /**设施部分*/
                var sstotal=parseInt(arr41[0]) + parseInt(arr41[1]) + parseInt(arr41[2]) + parseInt(arr41[3])+parseInt(arr42[0])+ parseInt(arr43[0])+parseInt(arr43[1])+parseInt(arr43[2])+parseInt(arr44[0]) + parseInt(arr44[1])+parseInt(arr45[0]) + parseInt(arr45[1])+ parseInt(arr45[2])+parseInt(arr46[0]) + parseInt(arr46[1])+parseInt(arr47[0])+parseInt(arr47[1])+parseInt(arr48[0]) + parseInt(arr48[1])+parseInt(arr49[0]) + parseInt(arr49[1])+num50+parseInt(arr51[0])+parseInt(arr52[0])+parseInt(arr53[0])+parseInt(arr53[1])+parseInt(arr54[0])+parseInt(arr54[1])+parseInt(arr54[2])+parseInt(arr54[3])+parseInt(arr54[4])+num55+parseInt(arr56[0])+parseInt(arr56[1]);
                ...
                $.post(window.apppath + "/admin/api/institution/org/areaHomePensionStarsAssess/updata", {
