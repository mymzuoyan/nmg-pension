    ...
    <tiles:putAttribute name="page_content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <shiro:hasPermission name="pension-service-manager-areaHomePensionStarsList-update">
                                ...
                                <table class="head_table table  table-bordered" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td cospan="5">
                                            ...
                                            <label><input type="number" value="0" oninput="if(value>5 || value.length >1) value=0"
                                                          class="in38" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填):对投诉未处理、记录、整改、反馈，按照现场查勘情况扣1-5分</span></label><br>
                                        </td>
                                        <td class="fen" style="text-align: center">10</td>
        ...
        <script>
            ...
            jQuery(document).ready(function () {
                ...
                $("label").click(function () {
                    ...
                    $(this).parent().parent().find(".pf19").html(parseInt(arr19[0])+parseInt(arr19[1])-$(".in19").val());
...
*/
                ...
                $.post(window.apppath + "/admin/api/institution/org/areaHomePensionStars/updata", {
