            ...
            <div class="portlet " style="padding-top: 0px !important;">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase">养老服务组织新增</span>
                    </div>
                </div>
                    ...
                    <div class="tabbable-line">
                        <form id="serviceOrgAddForm">
                            <table border="1"
                                ...
                                <tr>
                                    <td style="text-align: center;vertical-align: middle">
                                        城乡类型<span style="color:red"> *</span>
                                    </td>
                                    <td style="text-align: left;vertical-align: middle">
                                        <div class="td2 radio-list">
                                            <input type="hidden" id="cityOrTown" value="${m.cityOrTown}">
                                            <label class="radio-inline">
                                                <input type="radio" name="cityOrTown" value="1"/>
                                                城市
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="cityOrTown" value="2"/>
                                                农村
                                            </label>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div style="display: inline-block" class="file-box">
                                            <input type="file" name="files" id="attachInput"
                                                   onchange="UploadImage('serviceOrg/attach','attachInput','attach')"
                                                   style="opacity: 0;">
                            ...
                            <div class="form-actions">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-offset-6">
                                        <button onclick="window.parent.closeTab('tab_service_org_add')"
