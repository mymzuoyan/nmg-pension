...
<tiles:insertDefinition name="tiles.template.admin.layout">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- Begin: life time stats -->
                    <shiro:hasPermission name="person-institution-manager-subsidyList-update">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline" style="padding-left: 0px">
                                            <input type="checkbox" name="fraction09" data-score="20"
                                                   value="2"/>符合<span style="display: none" class="thisSpan">20</span></label><br/><br/>
                                        <label><input type="number" value="${star.in09Score}" oninput="if(value>10 || value.length >1) value=0"
                                                      class="in09" max="10" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：记录不规范不完整按照现场查勘情况扣1-10分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline" style="padding-left: 0px">
                                            <input type="checkbox" name="fraction11" data-score="10"
                                                   value="2"/>符合<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in11Score}" oninput="if(value>5 || value.length >2) value=0"
                                                      class="in11" max="5" min="2" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：设置不规范按照现场查勘情况扣2-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction18" data-score="10"
                                                   value="1"/>有台账资料<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in18Score}" oninput="if(value>10 || value.length >4) value=0"
                                                      class="in18" max="10" min="4" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：资料不全或欠规范以现场查勘情况扣4-10分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline" style="padding-left: 0px">
                                            <input type="checkbox" name="fraction21" data-score="2"
                                                   value="2"/>有消防安全<span style="display: none" class="thisSpan">2</span></label>
                                        <label class="checkbox-inline" style="padding-left: 0px">
                                            <input type="checkbox" name="fraction21" data-score="2"
                                                   value="3"/>有食品采购安全<span style="display: none" class="thisSpan">2</span></label>
                                        <label class="checkbox-inline" style="padding-left: 10px">
                                            <input type="checkbox" name="fraction21" data-score="2"
                                                   value="4"/>有安全设施安全<span style="display: none" class="thisSpan">2</span></label><br /><br />
                                        <label><input type="number" value="${star.in21Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in21" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：安全工作自查记录不规范不完整按照现场查勘情况扣1-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction26" data-score="5"
                                                   value="1"/>有24小时当班值班服务记录、护理交接班记录<span style="display: none" class="thisSpan">5</span></label><br /><br/>
                                        <label><input type="number" value="${star.in26Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in26" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：记录内容不完整不规范，以现场查勘情况扣分1-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <div class="checkbox-list">
                                        ...
                                        <label><input type="number" value="${star.in28Score}" oninput="if(value>10 || value.length >1) value=0"
                                                      class="in28" max="10" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：以现场询问、查勘为准</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction32" data-score="0"
                                                   value="1"/>符合<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in32Score}" oninput="if(value>10 || value.length >1) value=0"
                                                      class="in32" max="10" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：以现场查勘情况为准</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction38" data-score="10"
                                                   value="1"/>每年组织两次以上的大型活动或未制定“大型活动突发事件预案”<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in38Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in38" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：活动记录及制定“突发事件预案”不规范以现场查勘为准，视情况扣1-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction39" data-score="10"
                                                   value="1"/>制定消毒制度、实施消毒<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in39Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in39" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：消毒记录不规范、不完整以现场查勘情况扣1-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction40" data-score="5"
                                                   value="1"/>公布食谱<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in40Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in40" max="5" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：膳食荤素搭配、符合地域、民族、宗教习惯以现场勘查情况扣1-5分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction54" data-score="10"
                                                   value="1"/>有考核制度、有实施考核工作<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in54Score}" oninput="if(value>10 || value.length >1) value=0"
                                                      class="in54" max="10" min="0" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：考核制度及实施考核不规范视情况扣分</span></label>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                    ...
                                    <div class="checkbox-list">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="fraction57" data-score="10"
                                                   value="1"/>建立自评分析制度、自评分析<span style="display: none" class="thisSpan">10</span></label><br/><br/>
                                        <label><input type="number" value="${star.in57Score}" oninput="if(value>5 || value.length >1) value=0"
                                                      class="in57" max="5" min="2" style="width: 100px"/><span style="color: red;font-weight: bold;margin-right: 5px">*备注(评估人员选填)：记录不规视情况扣2-5分</span></label><br>
                                    </div>
                                </td>
                                <td colspan="1"
                                    style="text-align:center;vertical-align:middle;">
                                ...
                                <div id="update" class="col-md-12">
                                    <div class="col-md-offset-8"
                                        ...
                                        <button data-loading-text="提交中..."
                                                ...
                                                onclick="StarAssessCommon.submitEdit()"
                                                disabled
                                                name="updateStar">
                                            保存
                                        </button>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/star_assess_common.js?v=1.7"
                type="text/javascript"></script>
        <script>
            jQuery(document).ready(function () {
                Metronic.init();
                init();
                StarAssessCommon.show();
            ...
            $("label").click(function () {
                ...
                obj9_9_9 = obj9_9;
                $(this).parent().parent().parent().find(".pf9").html(parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val());
                if(parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val() > 0){
                    $(this).parent().parent().parent().find(".pf9").html(parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val());
                    obj9_9_9_score = parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val();
                    $(".in09").blur(function () {
                        $(".pf9").html(parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val());
                        obj9_9_9_score=parseInt(arr9[0]) + parseInt(arr9[1])-$(".in09").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf9").html(0);
                    obj9_9_9_score = 0;
                }
                ...
                // $(this).parent().parent().parent().find(".pf11").html(parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val());
                // if(parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val() > 0){
                //     $(this).parent().parent().parent().find(".pf11").html(parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val());
                //     obj11_11_score = parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val();
                //     $(".in11").blur(function () {
                //         $(".pf11").html(parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val());
                //         obj11_11_score=parseInt(arr11[0]) + parseInt(arr11[1]) -$(".in11").val();
                //     })
                // }else{
                //     $(this).parent().parent().parent().find(".pf11").html(0);
                //     obj11_11_score = 0;
                // }
                ...
                if(parseInt(arr11[0]) + parseInt(arr11[1])-$(".in11").val() > 0){
                    $(this).parent().parent().parent().find(".pf11").html(parseInt(arr11[0]) + parseInt(arr11[1])-$(".in11").val());
                    obj11_11_11_score = parseInt(arr11[0]) + parseInt(arr11[1])-$(".in11").val();
                    $(".in11").blur(function () {
                        $(".pf11").html(parseInt(arr11[0]) + parseInt(arr11[1])-$(".in11").val());
                        obj11_11_11_score=parseInt(arr11[0]) + parseInt(arr11[1])-$(".in11").val();
                    })
                ...
                $(this).parent().parent().parent().find(".pf18").html(parseInt(arr18[0]) -$(".in18").val());
                if(parseInt(arr18[0]) -$(".in18").val() > 0){
                    $(this).parent().parent().parent().find(".pf18").html(parseInt(arr18[0]) -$(".in18").val());
                    obj18_18_score = parseInt(arr18[0]) -$(".in18").val();
                    $(".in18").blur(function () {
                        $(".pf18").html(parseInt(arr18[0]) -$(".in18").val());
                        obj18_18_score=parseInt(arr18[0]) -$(".in18").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf18").html(0);
                    obj18_18_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf21").html(parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val());
                if(parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val() > 0){
                    $(this).parent().parent().parent().find(".pf21").html(parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val());
                    obj20_20_20_score = parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val();
                    $(".in21").blur(function () {
                        $(".pf21").html(parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val());
                        obj20_20_20_score=parseInt(arr21[0]) + parseInt(arr21[1]) + parseInt(arr21[2]) + parseInt(arr21[3]) - $(".in21").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf21").html(0);
                    obj20_20_20_score = 0;
                }
                ...
                $(".in09,.in11,.in18,.in21").blur(function () {
                ...
                $(this).parent().parent().parent().find(".pf26").html(parseInt(arr26[0]) -$(".in26").val());
                if(parseInt(arr26[0]) -$(".in26").val() > 0){
                    $(this).parent().parent().parent().find(".pf26").html(parseInt(arr26[0]) -$(".in26").val());
                    obj26_26_score = parseInt(arr26[0]) -$(".in26").val();
                    $(".in26").blur(function () {
                        $(".pf26").html(parseInt(arr26[0]) -$(".in26").val());
                        obj26_26_score=parseInt(arr26[0]) -$(".in26").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf26").html(0);
                    obj26_26_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf28").html(10-$(".in28").val());
                obj28_28_28_score = 10-$(".in28").val();
                $(".in28").blur(function () {
                    $(".pf28").html(10-$(".in28").val());
                    obj28_28_28_score=10-$(".in28").val();
                })
                ...
                $(this).parent().parent().parent().find(".pf32").html(parseInt(arr32[0])-$(".in32").val());
                if(parseInt(arr32[0])-$(".in32").val() > 0){
                    $(this).parent().parent().parent().find(".pf32").html(parseInt(arr32[0])-$(".in32").val());
                    obj32_32_score = parseInt(arr32[0])-$(".in32").val();
                    $(".in32").blur(function () {
                        $(".pf32").html(parseInt(arr32[0])-$(".in32").val());
                        obj32_32_score=parseInt(arr32[0])-$(".in32").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf32").html(0);
                    obj32_32_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf38").html(parseInt(arr38[0])-$(".in38").val());
                if(parseInt(arr38[0])-$(".in38").val() > 0){
                    $(this).parent().parent().parent().find(".pf38").html(parseInt(arr38[0])-$(".in38").val());
                    obj38_38_score = parseInt(arr38[0])-$(".in38").val();
                    $(".in38").blur(function () {
                        $(".pf38").html(parseInt(arr38[0])-$(".in38").val());
                        obj38_38_score=parseInt(arr38[0])-$(".in38").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf38").html(0);
                    obj38_38_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf39").html(parseInt(arr39[0])-$(".in39").val());
                if(parseInt(arr39[0])-$(".in39").val() > 0){
                    $(this).parent().parent().parent().find(".pf39").html(parseInt(arr39[0])-$(".in39").val());
                    obj39_39_score = parseInt(arr39[0])-$(".in39").val();
                    $(".in39").blur(function () {
                        $(".pf39").html(parseInt(arr39[0])-$(".in39").val());
                        obj39_39_score=parseInt(arr39[0])-$(".in39").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf39").html(0);
                    obj39_39_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf40").html(parseInt(arr40[0])-$(".in40").val());
                if(parseInt(arr40[0])-$(".in40").val() > 0){
                    $(this).parent().parent().parent().find(".pf40").html(parseInt(arr40[0])-$(".in40").val());
                    obj40_40_score = parseInt(arr40[0])-$(".in40").val();
                    $(".in40").blur(function () {
                        $(".pf40").html(parseInt(arr40[0])-$(".in40").val());
                        obj40_40_score=parseInt(arr40[0])-$(".in40").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf40").html(0);
                    obj40_40_score = 0;
                }
                ...
                $(".in26,.in28,.in32,.in38,.in39,.in40").blur(function () {
                ...
                $(this).parent().parent().parent().find(".pf54").html(parseInt(arr54[0])-$(".in54").val());
                if(parseInt(arr54[0])-$(".in54").val() > 0){
                    $(this).parent().parent().parent().find(".pf54").html(parseInt(arr54[0])-$(".in54").val());
                    obj54_54_score = parseInt(arr54[0])-$(".in54").val();
                    $(".in54").blur(function () {
                        $(".pf54").html(parseInt(arr54[0])-$(".in54").val());
                        obj54_54_score=parseInt(arr54[0])-$(".in54").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf54").html(0);
                    obj54_54_score = 0;
                }
                ...
                $(this).parent().parent().parent().find(".pf57").html(parseInt(arr57[0])-$(".in57").val());
                if(parseInt(arr57[0])-$(".in57").val() > 0){
                    $(this).parent().parent().parent().find(".pf57").html(parseInt(arr57[0])-$(".in57").val());
                    obj57_57_score = parseInt(arr57[0])-$(".in57").val();
                    $(".in54").blur(function () {
                        $(".pf54").html(parseInt(arr57[0])-$(".in57").val());
                        obj57_57_score=parseInt(arr57[0])-$(".in57").val();
                    })
                }else{
                    $(this).parent().parent().parent().find(".pf57").html(0);
                    obj57_57_score = 0;
                }
