...
<tiles:insertDefinition name="tiles.template.admin.layout">
                    ...
                    <div class="portlet-title">
                        <div class="caption tabbable-line" style="padding: 0px">
                            <ul class="nav nav-tabs">
                                <li>
                                    <a onclick="if(!$(this).parent().hasClass('active')) window.location.href='${pageContext.request.contextPath}/admin/providersDetail/${id}'"
                                       data-toggle="tab" aria-expanded="false">社会服务企业信息</a>
                                </li>
                                <li class="active">
                                    <a onclick="if(!$(this).parent().hasClass('active')) window.location.href='${pageContext.request.contextPath}/admin/providersDetailMap/${id}'"
                                       data-toggle="tab" aria-expanded="true">社会服务企业定位
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="https://api.map.baidu.com/api?v=2.0&ak=UtTMI5ofPulxrOYjzLcEWHGXRlyAEfUB"></script>
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/serviceSource/service_org_map.js?v=2.2"></script>
        <!--加载鼠标绘制工具-->
        <script type="text/javascript"
