...
<tiles:insertDefinition name="tiles.template.admin.layout">
                ...
                <div class="portlet " style="padding-top: 0px !important;padding-bottom: 0px !important;">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">社会服务企业信息列表</span>
                        </div>
                        <div class="tools">
                            <shior:hasPermission name="providers-add">
                                <div style="float: left">
                                    <a href="${pageContext.request.contextPath}/admin/providers/Add"
                                       class="btn btn-circle btn-add"><i class="fa">新增</i></a>
                                </div>
                            </shior:hasPermission>
                    ...
                    <div class="portlet">
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <div class="table-actions-check-wrapper">
                                    <div class="pagination-panel"> 页数 <input type="text" id="page"
                                        ...
                                        <button
                                                ...
                                                onclick="ProvidersList.goToPage()" title="GO">GO
                                        </button>
                                    </div>
                                </div>
                                ...
                                <shior:hasPermission name="serviceOrg-delete">
                                    <div class=" right" style="text-align: right" id="serviceOrg-delete">
                                        <span></span>
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/admin/pages/scripts/providers/providers_list.js?v=1.2"
                type="text/javascript"></script>
