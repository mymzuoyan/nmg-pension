...
<tiles:insertDefinition name="tiles.template.admin.layout">
                    ...
                    <div id="searchDiv" class="portlet-body form" style="">
                        <table class="table table-bordered table-hover table-condensed table-responsive">
                            <tr>
                                ...
                                <td width="15%" style="text-align:center;vertical-align:middle;">
                                    <input class="form-control" name="areaName" id="areaName"
                                           onclick="ForGoldSendList.selectArea();"
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;vertical-align:middle;">
                                    <input class="form-control" style="width: 46%;display: inline-block" type="text" id="startAge" name="startAge" maxlength="3" size="5"/>
                                    至&nbsp;<input type="text"  style="width: 46%;display: inline-block"  class="form-control" id="endAge" name="endAge" maxlength="3" size="5"/>
                                </td>--%>
                            </tr>
                        </table>
                            ...
                            <div class="table-actions-check-wrapper">
                                <div class="pagination-panel"> 页数 <input type="text" id="page"
                                    ...
                                    <button
                                            ...
                                            onclick="ForGoldSendList.goToPage()" title="GO">GO
                                    </button>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                                onclick="ForGoldSendList.getAreaValue(AreaTree.getAllAreaName(AreaTree.getSelectArea()),AreaTree.getSelectArea());">
                            确定
                        </button>
                    </div>
                </div><!-- /.modal-content -->
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script src="${pageContext.request.contextPath }/assets/global/plugins/jstree/dist/jstree.min.js"
                type="text/javascript"></script>
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/gold/gold_send_list.js?v=2.5"></script>
