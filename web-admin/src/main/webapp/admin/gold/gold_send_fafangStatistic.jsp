...
<tiles:insertDefinition name="tiles.template.admin.layout">
        ...
        <div class="col-md-12">
            <div class="portlet">
                        ...
                        <tr>
                            ...
                            <td width="35%" style="text-align:center;vertical-align:middle;">
                                <input class="form-control" name="areaName" id="areaName"
                                       onclick="GoldSendStatistics.selectArea();"
                ...
                <div class="portlet-body">
                    ...
                    <a  class="btn btn-circle green"  id="loadPDF">
                        生成PDF
                    </a>
                    <a  class="btn btn-circle green"  id="loadWord">
                        生成Word
                    </a>
                    <div>&nbsp;</div>
                    <div id="goldSendWord">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                                onclick="GoldSendStatistics.getAreaValue(AreaTree.getAllAreaName(AreaTree.getSelectArea()),AreaTree.getSelectArea());">
                            确定
                        </button>
                    </div>
                </div><!-- /.modal-content -->
    ...
    <tiles:putAttribute name="page_script">
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/gold/gold_send_fafangStatistic.js?v=1.7"></script>
        <script type="text/javascript"
        ...
        <script src="${pageContext.request.contextPath }/assets/global/plugins/jstree/dist/jstree.min.js"
                type="text/javascript"></script>
        <script type="text/javascript"
                src="${pageContext.request.contextPath }/assets/admin/pages/scripts/gold/gold_send_fafangStatistic.js?v=3.9"></script>
